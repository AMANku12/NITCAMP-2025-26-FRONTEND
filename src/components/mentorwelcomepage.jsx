...
const MentorWelcomePage = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white px-4 sm:px-8">
      ...
      <p className="text-base sm:text-lg text-[#5B6C94] mb-4 sm:mb-8 text-center max-w-md sm:max-w-2xl">
        Thank you for registering! We're thrilled to have you with us.
      </p>

      <div className="bg-[#EDF2FF] border border-[#CBD5E1] text-[#1E293B] rounded-2xl px-4 sm:px-10 py-6 sm:py-8 w-full max-w-md sm:max-w-2xl text-center shadow-md">
