...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-gray-100 flex items-center justify-center p-2">
      ...
      {/* Main content card */}
      <div className="relative bg-white rounded-2xl shadow-xl p-4 w-full max-w-md">
        <div className="flex justify-center mb-6">
          <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gray-800 rounded-full flex items-center justify-center">
            <img src={logo} alt="NIT Calicut" className="w-10 h-10 sm:w-14 sm:h-14 object-contain" />
          </div>
        </div>
        ...
        <div className="mt-6 text-center text-sm text-gray-500 space-y-2">
          ...
          <p>
            <Link to="/register" className="text-blue-600 hover:underline text-xs sm:text-sm">
              New user? Register
            </Link>
          </p>
        </div>
