      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="w-full">
          ...
          <div className="text-center mb-10 sm:mb-16">
            ...
            <p className="text-base sm:text-xl text-gray-700 font-light leading-relaxed max-w-md sm:max-w-2xl mx-auto">
          ...
          <div className="border-t border-b border-gray-200 py-8 sm:py-12">
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#1e3a8a] rounded-full flex items-center justify-center">
              ...
              <div className="text-center">
                <h2 className="text-lg sm:text-2xl font-light text-[#0f172a] mb-1 sm:mb-2">Please Check Your Email</h2>
          ...
          <div className="text-center mt-10 sm:mt-16">
            <p className="text-sm sm:text-lg text-gray-500 font-light italic">
